...
public class PCStack
{
	...
	private static final int J9JavaInstructionSizeAndBranchActionTableVersion2[] = {
			0x01 /* JBnop = 0 */,
			0x01 /* JBaconstnull = 1 */,
			0x01 /* JBiconstm1 = 2 */,
			0x01 /* JBiconst0 = 3 */,
	...
	private static final int JavaStackActionTableVersion2[]= {
			0x00 /* JBnop = 0  -- pops: 0 pushes: 0*/ ,
			0x50 /* JBaconstnull = 1  -- pops: 0 pushes: 1*/ ,
			0x10 /* JBiconstm1 = 2  -- pops: 0 pushes: 1*/ ,
			0x10 /* JBiconst0 = 3  -- pops: 0 pushes: 1*/ ,
			...
			0x50 /* JBaload0getfield = 216  -- pops: 0 pushes: 1*/ ,
			0x50 /* JBnewdup = 217  -- pops: 0 pushes: 1*/ ,
			0x00 /* JBunimplemented = 218  -- pops: 0 pushes: 0*/ ,
			0x00 /* JBunimplemented = 219  -- pops: 0 pushes: 0*/ ,
			0x00 /* JBunimplemented = 220  -- pops: 0 pushes: 0*/ ,
			0x00 /* JBunimplemented = 221  -- pops: 0 pushes: 0*/ ,
	...
	private static final int J9BytecodeSlotUseTableVersion2[] = {
			0x0 /* JBnop (16r0) */,
			0x0 /* JBaconstnull (16r1) */,
			0x0 /* JBiconstm1 (16r2) */,
			0x0 /* JBiconst0 (16r3) */,
			...
			0x0 /* JBdefaultvalue (16rCB) */ ,
			0x0 /* JBwithfield (16rCC) */ ,
			0x48 /* JBiloadw (16rCD) <islot><wide><read>*/,
			0x28 /* JBlloadw (16rCE) <dslot><wide><read>*/,
			0x48 /* JBfloadw (16rCF) <islot><wide><read>*/,
			0x28 /* JBdloadw (16rD0) <dslot><wide><read>*/,
			0x7c /* JBaloadw (16rD1) <oslot><wide><read>*/,
			0x58 /* JBistorew (16rD2) <islot><wide><write>*/,
			0x38 /* JBlstorew (16rD3) <dslot><wide><write>*/,
			0x58 /* JBfstorew (16rD4) <islot><wide><write>*/,
			0x38 /* JBdstorew (16rD5) <dslot><wide><write>*/,
			0x98 /* JBastorew (16rD6) <oslot><wide><write>*/,
			0x48 /* JBiincw (16rD7) <islot><wide><read>*/,
			0x84 /* JBaload0getfield (16rD8) <oslot><read><encodedparam>*/,
			0x0 /* JBnewdup (16rD9) */,
			0x0 /* JBunimplemented (16rDA) */,
			0x0 /* JBunimplemented (16rDB) */,
			0x0 /* JBunimplemented (16rDC) */,
	...
	static {		
		...
		case 1:
			...
			break;
		case 2:
			J9JavaInstructionSizeAndBranchActionTable = J9JavaInstructionSizeAndBranchActionTableVersion2;
			JavaStackActionTable = JavaStackActionTableVersion2;
			J9BytecodeSlotUseTable = J9BytecodeSlotUseTableVersion2;
			break;
		default:
